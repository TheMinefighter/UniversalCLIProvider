...
public class CmdDefaultActionAttribute : Attribute {
	...
	/// <remarks>
	///  When the number of parameters supplied to the <see cref="T:UniversalCLIProvider.Attributes.CmdDefaultActionAttribute" />
	///  is on less than the number of parameters the marked method takes,
	///  the **last** parameter supplied will be the current <see cref="T:UniversalCLIProvider.Attributes.CmdContextAttribute" />
	/// </remarks>
