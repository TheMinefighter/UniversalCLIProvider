...
Mit der Umsetzung der Ziele die ich in Abschnitt \ref{sec:Future} kann die Bibliothek einen noch grö\ss eren Umfang an Anwendungsfällen abdecken. 
  ...
  \begin{outline}
   ...
   \1 Diese Arbeit im PDF Format
     \end{outline}
  Zum ausführen der Referrnzverwendung unter Windows, muss man die cmd.exe öffnen, und mit \inlinecode{cd /d} gefolgt mit dem Pfad des Ordners, der kompilierten Referenzverwendun, ausführen.
